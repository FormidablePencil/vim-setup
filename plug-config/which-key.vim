...
let g:vanilla_vim_map.6 = {
        \ 'name' : 'easymotion' ,
        \ '<leader><leader>f/'        : [ '','search by letter'],
        \ '<leader><leader>w/W or b/' : [ '','search by word'],
        \ '<leader><leader>n'         : [ '','search what has been searched'],
        \ }
...
let g:vanilla_vim_map.s = {
      \ 'name': 'surround.vim',
      \ 'cste'                  : [ '','delete surrounding tags'],
      \ 'cst => new tag'        : [ '','change to new tag'],
      \ 'cs]{'                  : [ '','replace [] with {}'],
      \ 'yssb or yss)'          : [ '','wrap entire line ()'],
      \ 'ysibB or ysi)'         : [ '','add {} on that outer side of () '],
      \ }
